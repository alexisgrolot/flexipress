...
if (get_option('wordpress-admin_enabled_removewordpressversionnumber', false)) {
...
if (get_option('wordpress-admin_enabled_disablegutenbergeditor', false)) {
    // Calls up the function to display the feature
...
if (get_option('wordpress-admin_enabled_disablethewpadminbar', false)) {
    // Calls up the function to display the feature
